...
# Type:		wt2g file, calculating page rank till convergance 
# ------------------------------------------------------------------------------
# ------------------------------------------------------------------------------
...
my $file_to_write = "Output_Wt2g_Perplexity.txt";
open FILE, ">".$file_to_write or die $!;
#print the perplexity values to the file
print FILE "Perplexity Values after iteration\n";	
close FILE;
# ------------------------------------------------------------------------------
...
while($not_converged eq "true"){
	...
	$counter++;			#counter to keep track of the iterations.
	open FILE, ">>".$file_to_write or die $!;
	    #print the perplexity values to the file
		print FILE "$counter. Perplexity: $perplexity\n";	
	close FILE;
